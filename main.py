...
parser.add_argument('-loss_thres', default=1., type=float, help='partion from (f_init-f_min)*thres')
parser.add_argument('-zeta', default=1, type=float, help='Adaptive hyperparameter')
parser.add_argument('-error', default=1e-3, type=float, help='Acceptable error')
